...
public class DB {
	...
	public static void main(String[] args) {
		...
		//db.runScript(RuntimeMysqlSettings.scriptSql);
	}
	...
	public void createDatabase(String databaseName) {
		try {
			...
			Connection con = DriverManager.getConnection(url,
					RuntimeMysqlSettings.dbUserID, 
					RuntimeMysqlSettings.dbPassword);
	...
	public static Connection getConnection() {
		...
		try {
			...
			String connectionUrl = "jdbc:mysql://" + RuntimeMysqlSettings.SERVER_IP
					+ ":" + RuntimeMysqlSettings.portNo + "/"
					+ RuntimeMysqlSettings.databaseName
					+ "?zeroDateTimeBehavior=convertToNull";
			con = DriverManager.getConnection(connectionUrl,
					RuntimeMysqlSettings.dbUserID, RuntimeMysqlSettings.dbPassword);
		} catch (SQLException ex) {
